...
export default async function Paddleboards({ searchParams }: { searchParams: Promise<URLSearchParams> }) {
    const { deserialize } = buildParameterSerializer();
    const urlParameters = deserialize(await searchParams);

    // Add search query for Paddleboards
    ...
    const { staticState, navigatorContext } = await fetchCoveoStaticState("searchEngineDefinition", {
        ...
        url: "https://sports.barca.group/paddleboards",
    });
    ...
    return (
        <SearchProvider staticState={staticState} navigatorContext={navigatorContext.marshal}>
            ...
            <div className="container mx-auto px-4 py-8">
                {/* Page Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Paddleboards</h1>
                    <p className="text-gray-600">Explore our range of high-quality paddleboards</p>
                </div>
