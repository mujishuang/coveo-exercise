...
export default async function Kayaks({ searchParams }: { searchParams: Promise<URLSearchParams> }) {
    ...
    return (
        <ListingProvider staticState={staticState} navigatorContext={navigatorContext.marshal}>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Kayaks</h1>
                    <p className="text-gray-600">Discover our collection of premium kayaks</p>
                </div>
